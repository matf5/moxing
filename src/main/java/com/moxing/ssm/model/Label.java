...
public class Label {
    ...
    public Integer getExtraversionScore() {
        return extraversionScore;
    }

    public void setExtraversionScore(Integer extraversionScore) {
        this.extraversionScore = extraversionScore;
    }

    public Integer getAgreeablenessScore() {
        return agreeablenessScore;
    }

    public void setAgreeablenessScore(Integer agreeablenessScore) {
        this.agreeablenessScore = agreeablenessScore;
    }

    public Integer getConscientiousnessScore() {
        return conscientiousnessScore;
    }

    public void setConscientiousnessScore(Integer conscientiousnessScore) {
